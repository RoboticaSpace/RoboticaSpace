...
namespace RNDO
{
    ...
    // 
    // Purpose:
    //      The utilites functions of the RNDO system
    //
    //----------------------------------------------------------------------------
    public class Utils
    {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static void PutbyteArrayTobyteArrayLocationToData(byte[] fromData, byte[] data, int location, int size)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static void PutbyteArrayTobyteArrayLocationFromData(byte[] fromData, byte[] data, int location, int size)
        {
            for (int index = 0; index < size; index++)
            {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static byte CalcCheckByte(byte[] data, int start, int number)
        {
            byte checkByte = 0xFF;
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static byte GetHexValue(byte firstByte, byte secondByte)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static byte GetHexByte(byte theByte)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static void SetAChunkOfU32(UInt32 dataToSave, UInt32 dataToSet, int location, int size)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static void SetAChunkOfU16(UInt16 dataToSave, UInt16 dataToSet, int location, int size)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static UInt32 GetAChunkOfU16(UInt16 data, int location, int size)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static void SetAChunkOfByte(byte dataToSave, byte dataToSet, int location, int size)
        {
            UInt32 tempData = (UInt32)dataToSave;
            SetAChunkOfU32(tempData, dataToSet, location, size);
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static byte GetAChunkOfByte(byte data, int location, int size)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static UInt16 AddCRC(UInt16 crc, byte b)
        {
        ...
        /// </remarks>
        ///--------------------------------------------------------------------
        public static UInt16 CalcCRC16(byte[] data, int start, int size)
        {
